 ...
 * 2019-05-22T16:29:47.564+01:00
 * Generated source version: 2.7.18
 * 
 */
@WebServiceClient(name = "youtube", 
                  wsdlLocation = "classpath:youtube.wsdl",
...
public class Youtube_Service extends Service {
    ...
    static {
        URL url = Youtube_Service.class.getClassLoader().getResource("youtube.wsdl");
        if (url == null) {
            java.util.logging.Logger.getLogger(Youtube_Service.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "classpath:youtube.wsdl");
        }       
        WSDL_LOCATION = url;   
    }
